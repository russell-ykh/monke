...
def visualise_reduced(reduced, labels, x_bound=None, y_bound=None, three_dimensional=False, title=None, save_fig=None, hide=-1, s=1):
    fig = plt.figure()
...
# save_as_path = path.join(cd, "features", "cic_vel", "boba_apr11_dir_change_umap.csv")
